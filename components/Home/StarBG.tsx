...
const StarBG = ({ show }: Props) => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      const rotate = Math.random() * 90 - 45 // Random from -45 to 45
      ...
      setStars((prev) =>
        [
          ...
          <Star
            key={key}
            style={{ '--top': `${top}px`, '--left': `${left}px`, '--rotate': `${rotate}deg` } as CSSProperties}
            index={randomNum}
          />,
        ].slice(-(width / 20))
      )
...
const Star = ({ style, index }: { style: CSSProperties; index: number }) => {
  return (
    <SparkleSVG style={style}>
      {index % 3 === 0 && BaseballSVG}
      {index % 3 === 1 && MusicNoteSVG}
      {index % 3 === 2 && SineWaveSVG}
    </SparkleSVG>
  )
}
...
const MusicNoteSVG = (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M160 64v257.6c-8.2-2.7-17.2-4.1-26.6-4.1-38.3 0-69.4 27.1-69.4 65.4 0 38.3 31.1 65.1 69.4 65.1 38.3 0 69.6-28.2 69.6-69.1V200h202v121.6c-8.2-2.7-17.2-4.1-26.6-4.1-38.3 0-69.4 27.1-69.4 65.4 0 38.3 31.1 65.1 69.4 65.1 38.3 0 69.6-28.2 69.6-69.1V64H160zm245 96H203v-53h202v53z"></path>
  </svg>
)
const SineWaveSVG = (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M232,128c-52,110.85-78,55.43-104,0ZM24,128H128C102,72.57,76,17.15,24,128Z" opacity="0.2"></path>
