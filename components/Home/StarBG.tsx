    ...
    const interval = setInterval(() => {
      ...
      setStars((prev) =>
        [
          ...prev,
          <Star
            style={{ top: Math.random() * height, left: Math.random() * width }}
...
const Star = ({ style, index }: { style: CSSProperties | undefined; index: number }) => {
  return (
...
const SparkleSVG = styled.span`
  position: absolute;
  animation: sparkle 7.5s ease forwards;
  opacity: 0;
  color: #414141;
`
