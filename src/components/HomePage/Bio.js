...
function Bio() {
  return (
    <Description variants={staggerFade} className="max-w-screen">
      ...
      <motion.p variants={fade}>
        When I'm not in front of my laptop, I'm either out riding a bike or lifting. I also dabble
        with winemaking, photography, and learning how to think and write better.
      </motion.p>
    </Description>
  );
}
